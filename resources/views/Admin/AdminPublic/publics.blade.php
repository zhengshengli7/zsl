        ...
        <div id="mws-sidebar">
            ...
            <div id="mws-searchbox" class="mws-inset">
                <form action="typography.html">
                    ...
                    <button type="submit" class="mws-search-submit"><i class="icon-search"></i></static/Adminsutton>
                </form>
            </div>
            ...
            <div id="mws-navigation">
                <ul>
                    <li>
                        ...
                        <ul class="closed">
                            <li><a href="/php216/project/public/adminusers/create">用户添加</a></li>
                            <li><a href="/php216/project/public/adminusers">用户列表</a></li>
                        </ul>
                    </li>
